package com.example.ibadahkuy.reminder;
...
import com.example.ibadahkuy.R;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        buttonTimePicker.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                DialogFragment timePicker = new com.example.ibadahkuy.reminder.TimePicker();
        ...
        buttonCancelAlarm.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                cancelAlarm();
                Toast.makeText(ReminderActivity.this, "Reminder Di Batalkan",
...
//        updateTimeText(c);
    ...
    private void startAlarm(Calendar c) {
        ...
        Toast.makeText(ReminderActivity.this, "Reminder Telah Di Atur",
                Toast.LENGTH_SHORT).show();
    }
